...
if selected == "Prijslijst":
    ...
    edited = st.data_editor(
        ...
        column_config={
            ...
            "Huidige m2 prijs": st.column_config.NumberColumn(disabled=True, format="€ %.2f",),
            "RSP": st.column_config.NumberColumn(disabled=True, format="€ %.2f",),
            "Handmatige prijs": st.column_config.NumberColumn(help="Laat leeg om RSP te gebruiken", format="€ %.2f",),
            "Final prijs": st.column_config.NumberColumn(disabled=True,format="€ %.2f",),
            "Prijskwaliteit": st.column_config.TextColumn(disabled=True),
            "New Prijskwaliteit": st.column_config.TextColumn(disabled=True),
